 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://service.wxg.com/", wsdlLocation = "http://localhost:8989/ws/bb?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://service.wxg.com/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8989/ws/bb?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://service.wxg.com/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.wxg.com/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
